...
int main(int argc, char* argv[]) {
    ...
    Material* m2 = new Material(new Color(0.05, 0.05, 0.05), new Color(0, 0, 1), new Color(1, 1, 1), NULL, 32);

    world->addShape(new Sphere(new Point(8,0,6), 5.0, world, NULL, m1));
    world->addShape(new Sphere(new Point(-8,0,6), 5.0, world, NULL, m2));

    world->addLight(new Point_Light(new Color(1,1,1), new Point(2,2,2), 0));
    //world->addLight(new Point_Light(new Color(1,1,1), new Point(-2,2,2), 0));
